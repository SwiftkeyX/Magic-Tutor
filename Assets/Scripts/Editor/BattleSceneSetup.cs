...
public static class BattleSceneSetup
{
    ...
    public static void Execute()
    {
        ...
        // EventSystem — StandaloneInputModule requires "Both" input backends in Player Settings
    ...
    private static void EnsureInputHandlingBoth()
    {
        ...
        Debug.Log("[BattleSceneSetup] Set Active Input Handling to 'Both' so StandaloneInputModule works.");
    }
}
